...
class RadarFrame:
    ...
    def __init__(self, data: 'list[dict[str, int or float]]'):
        ...
        self.z = []
        self.ts = []
        self.is_static = [] # -1 default, 1 static, 0 not static. checked by static points class
        for item in data: 
...
class RadarData:
    ...
    def transform_coord(self, s1_rotz, s1_rotx, s2_rotz, s2_rotx, offsetx, offsety, offsetz):
